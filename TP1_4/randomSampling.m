...
nbPts = 50000;
cate = categorical ({'bedroom';'CALsuburb';'industrial';'kitchen';'livingroom';'MITcoast';'MITforest';'MIThighway';'MITinsidecity';'MITmountain';'MITopencountry';'MITstreet';'MITtallbuilding';'PARoffice';'store'});
